...
for j in range(7):
    for i in range(j*1000, (j+1)*1000):
        position_list2_tmp.append(position_list1[i])
        position_list1_tmp.append([0]*len(position_list2[i]))
        position_list3_tmp.append([0]*len(position_list3[i]))
        print("pos_tmp:"+str(i))
    for i in range(j*1000, (j+1)*1000):
        position_list2_tmp.append([0]*len(position_list1[i]))
        position_list1_tmp.append(position_list2[i])
        position_list3_tmp.append(position_list3[i])
for i in range(7000, 10100):
    position_list1_tmp.append(position_list1[i])
    position_list2_tmp.append(position_list2[i])
    position_list3_tmp.append(position_list3[i])
    print("pos_tmp:"+str(i))
position_list1 = position_list1_tmp
position_list2 = position_list2_tmp
position_list3 = position_list3_tmp
