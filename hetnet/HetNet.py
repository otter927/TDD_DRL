...
#from . import calc_capacity_rapper as capa
...
#        )
    ...
    def learning(self, reward):
        ...
        if self.sim.learning_mode == "MVG":
            self.weight_times = 1.0#0.99#1.0#0.999#1.0#0.0#1.0#0.01#0.5#1.0        
    ...
    def get_observation(self, time_step):
        ...
        if ((self.get_type() == "MBS") and (time_step % self.mbs_interval == 0)) or ((self.get_type() == "SBS") and (time_step % self.sbs_interval == 0)):
            ...
            if len(self.ans_ul) > lim_len:
                ...
                self.ans_ul = self.ans_ul[-1-lim_len:-1]
            ...
            if len(self.ans_ul_num) > lim_len:
                ...
                self.ans_ul_num = self.ans_ul_num[-1-lim_len:-1]
            ...
            if len(self.ans_dl) > lim_len:
                ...
                self.ans_dl = self.ans_dl[-1-lim_len:-1]
            ...
            if len(self.ans_dl_num) > lim_len:
                ...
                self.ans_dl_num = self.ans_dl_num[-1-lim_len:-1]
...
class UE():
    ...
    def __init__(self, sim, UEtype, id_x, cell_color, x_pos, y_pos, z_pos, bs, arrival_rate):
        ...
        self.ul_random = np.random.poisson(arrival_rate, 18000) ##max_num self.arrival_rate * self.subframe_duration
        self.dl_random = np.random.poisson(arrival_rate, 18000) ##max_num
...
#            env = env + 1        
    ...
    def add_ue(self, UEtype, id_x, cell_color, x, y, bs):
        ue = UE(self, UEtype, id_x, cell_color, x, y, 0, bs, self.arrival_rate)
...
#######################
    ...
    def execute_random_mobility(self, position_list):
        ...
        #self.elapsed_time2 = time.perf_counter() - self.start2
        #print("timer: "+str(self.elapsed_time1+self.elapsed_time2) + ", " + str(count_calc))
        
            
        #elapsed_time1 = time.perf_counter()
        #elapsed_time = elapsed_time1 - start
        #print ("elapsed_time init:{0}".format(elapsed_time))
        ...
        for j in range(10):
            ...
            #elapsed_time = elapsed_time2 - elapsed_time1
            #print ("elapsed_time sendrecieve:{0}".format(elapsed_time)+", "+str(j))
        ...
        #elapsed_time21 = time.perf_counter()
        #elapsed_time = elapsed_time21 - elapsed_time1
        #print ("elapsed_time sendrecieve:{0}".format(elapsed_time))
...
#            i.move()
        ...
        #elapsed_time2 = time.perf_counter()
        #elapsed_time = elapsed_time2 - elapsed_time21
        #print ("elapsed_time sendrecieve:{0}".format(elapsed_time))
        ...
        #elapsed_time3 = time.perf_counter()
        #elapsed_time = elapsed_time3 - elapsed_time2
        #print ("elapsed_time move:{0}".format(elapsed_time))

        # gen new data    
        for i in self.UE_list:
            i.gen_random_data_ue(self.time_step // 10) 

        #elapsed_time4 = time.perf_counter()
        #elapsed_time = elapsed_time4 - elapsed_time3
        #print ("elapsed_time before_reward_A:{0}".format(elapsed_time))
        
        #set connecting_UE     
        self.set_send_recieve()

        #elapsed_time5 = time.perf_counter()
        #elapsed_time = elapsed_time5 - elapsed_time4
        #print ("elapsed_time before_reward_B:{0}".format(elapsed_time))
        ...
        #self.start1 = time.perf_counter()

        #elapsed_time6 = time.perf_counter()
        #elapsed_time = elapsed_time6 - elapsed_time5
        #print ("elapsed_time before_reward_C:{0}".format(elapsed_time))
        ...
        #self.elapsed_time1 = time.perf_counter() - self.start1
        
        #elapsed_time7 = time.perf_counter()
        #elapsed_time = elapsed_time7 - elapsed_time6
        #print ("elapsed_time reward:{0}".format(elapsed_time))
